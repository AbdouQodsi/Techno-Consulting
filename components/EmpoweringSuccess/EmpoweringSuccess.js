...
import eImg from '/public/images/1577.jpg'
...
const EmpoweringSuccess = (props) => {
    ...
    return (
        ...
        <section className="empowering_success_section section_space bg-light">
              ...
              <div className="col-lg-10">
                <div className="heading_block text-center">
                  <h2 className="heading_text mb-0">
                    Empowering Success Through Strategic Consulting Since 2014
                  </h2>
                </div>
              </div>
            </div>
          ...
          <ModalVideo channel='youtube' autoplay isOpen={isOpen} videoId="Kv3a_4wRU9I" onClose={() => setOpen(false)} />
        </section>
    )
}
